...
export interface IRichReplyMetadata {
     ...
     * will contain the event as reported by the node. May be null if
     * wasLenient is true.
     */
    realEvent: any;
}
...
export class RichRepliesPreprocessor implements IPreprocessor {
    ...
    public async processEvent(event: any, client: SDNClient, kind?: EventKind): Promise<any> {
        ...
        if (event["content"]["format"] !== "org.sdn.custom.html" || !event["content"]["formatted_body"]) {
