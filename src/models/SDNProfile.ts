...
/**
 * Profile information commonly associated with SDN profiles
 * @category Models
 */
export interface SDNProfileInfo {
    /**
...
export class SDNProfile {
     ...
     */
    constructor(private userId: string, private profile: SDNProfileInfo) {
    }
