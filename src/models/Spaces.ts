...
import { UserID } from "../helpers/SDNEntity";
...
/**
 * An instance representing a SDN Space. A space is tied to a room.
 * @category Models
 */
export class Space {
    public constructor(public readonly roomId: string, public readonly client: SDNClient) {
    }
