...
export class MentionPill {
     ...
     * @param {SDNClient} client Optional client for creating a more pleasing mention.
     * @returns {Promise<MentionPill>} Resolves to the user's mention.
     */
    public static async forUser(userId: string, inRoomId: string = null, client: SDNClient = null): Promise<MentionPill> {
     ...
     */
    public static async forRoom(roomIdOrAlias: string, client: SDNClient = null): Promise<MentionPill> {
