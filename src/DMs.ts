 ...
 * on the node as account data and thus survives the bot's own storage
 * being wiped.
 * @category Utilities
 */
export class DMs {
     ...
     * @param {SDNClient} client The client the DM map is for.
     */
    public constructor(private client: SDNClient) {
     ...
     * be created as an encrypted DM (if both the SDNClient and target user support
